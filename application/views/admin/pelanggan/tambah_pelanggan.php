<div class="container-fluid py-0 mt-7">
    <div class="row">
        <div class="col-12">
            <div class="card mb-0">
                <div class="card-body ">
                    <form action="<?= base_url() ?>admin/proses-tambah-pelanggan" method="post">
                        ...
                        <div class="form-group"">
                            ...
                            <select class="form-select" aria-label="Default select example" name="lokasi_server" id="lokasi_server">
                                ...
                                <?php foreach ($lokasi as $l) : ?>
                                    <option value="<?= $l->id_lokasi_server ?>" <?php echo set_select('lokasi_server', $l->id_lokasi_server); ?>><?= $l->lokasi_server ?></option>
                                <?php endforeach; ?>
                            </select>
