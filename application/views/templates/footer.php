...
<div class="modal fade" id="pesanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Anda belum dapat menambah kuesioner karena belum genap 6 bulan.
            </div>
            <div class="modal-footer">
                <button type="button" class="btn bg-gradient-primary" data-bs-dismiss="modal">Oke</button>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <?php if ($this->session->userdata('jabatan') == 'Manajer' or $this->session->userdata('jabatan') == 'Admin') : ?>
                    <a href="<?= base_url() ?>auth/logout_pegawai" class="btn bg-gradient-primary">Ya</a>
                <?php else : ?>
                    <a href="<?= base_url() ?>auth/logout_pelanggan" class="btn bg-gradient-primary">Ya</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
