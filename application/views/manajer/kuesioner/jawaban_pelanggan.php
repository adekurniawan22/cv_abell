                                ...
                                <div class="col-6 mb-3">
                                    <div class="table-responsive mx-2 mb-4">
                                        <div class="card p-3" style="background-color: #f0f0f0;">
                                            <?php
                                            $pelanggan = $this->db->get_where('t_pelanggan', ['id_pelanggan' => $s->id_pelanggan])->row();
                                            ?>
                                            <h6>Nama : <?= $pelanggan->nama_lengkap ?></h6>
                                            <?php $lokasi_server = $this->db->get_where('t_lokasi_server', ['id_lokasi_server' => $pelanggan->lokasi_server])->row(); ?>
                                            ...
                                            <h6>Lama Berlangganan :
                                                ...
                                                if ($selisih->m !== 0) {
                                                    echo $selisih->m . ' Bulan' . ($selisih->d !== 0 ? ', ' : ' ');
                                                }
                                                if ($selisih->d !== 0) {
                                                    echo $selisih->d . ' Hari';
                                                }
