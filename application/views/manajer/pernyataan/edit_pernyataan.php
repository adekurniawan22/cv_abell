<div class="container-fluid py-0 mt-7">
    <div class="row">
        <div class="col-12">
            <div class="card mb-0">
                <div class="card-body ">
                    <form action="<?= base_url() ?>manajer/proses-edit-pernyataan" method="post">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="id_dimensi" id="id_dimensi">
                                        ...
                                        <?php foreach ($dimensi as $d) : ?>
                                            <option value="<?= $d->id_dimensi ?>" <?php echo set_select('id_dimensi', $d->id_dimensi, $pernyataan->id_dimensi == $d->id_dimensi); ?>> <?= $d->dimensi ?></option>
                                        <?php endforeach ?>
                                    </select>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="pernyataan" id="pernyataan" rows="3"><?php echo set_value('pernyataan', $pernyataan->pernyataan); ?></textarea>
                            ...
                            <div class="col-5">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="rekomendasi_perbaikan" id="rekomendasi_perbaikan" rows="3"><?php echo set_value('rekomendasi_perbaikan', $pernyataan->rekomendasi_perbaikan); ?></textarea>
