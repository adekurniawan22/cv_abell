                    ...
                    <form action="<?= base_url() ?>manajer/proses-tambah-pengguna" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="role" id="role" onchange="handleRoleChange()">
                                ...
                                <option value="Manajer" <?php echo set_select('role', "Manajer"); ?>>Manajer</option>
                                <option value="Admin" <?php echo set_select('role', "Admin"); ?>>Admin</option>
                                <option value="Pelanggan" <?php echo set_select('role', "Pelanggan"); ?>>Pelanggan</option>
                            </select>
                        ...
                        <div class="form-group" id="lokasi-form-group" style="display: none;">
                            ...
                            <select class="form-select" aria-label="Default select example" name="lokasi" id="lokasi">
                                ...
                                <?php foreach ($lokasi as $l) : ?>
                                    <option value="<?= $l->lokasi_server ?>" <?php echo set_select('lokasi', $l->lokasi_server); ?>><?= $l->lokasi_server ?></option>
                                <?php endforeach; ?>
                            </select>
